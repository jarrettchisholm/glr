...
private:
	 ...
	 */
	glmd::float32 getInterpolatedNoise(const Points& points, glmd::int32 gridX, glmd::int32 gridY, glmd::int32 gridZ, glmd::float32 x, glmd::float32 y, glmd::float32 z) const;
	
	/**
	 * Calculate the normal for the provided point.
	 */
	glm::vec3 calculateNormal(const glm::vec3& point, glmd::int32 gridX, glmd::int32 gridY, glmd::int32 gridZ, const Points& densityValues) const;
	
	/**
	 * Find the intersection along the x-axis where the line segment between p0 and p1 would intersect with the isosurface.
	 */
	void intersectXAxis(Point& p0, Point& p1, Point& out, glmd::int32 gridX, glmd::int32 gridY, glmd::int32 gridZ, const Points& densityValues) const;
	
	/**
	 * Find the intersection along the y-axis where the line segment between p0 and p1 would intersect with the isosurface.
	 */
	void intersectYAxis(Point& p0, Point& p1, Point& out, glmd::int32 gridX, glmd::int32 gridY, glmd::int32 gridZ, const Points& densityValues) const;
	
	/**
	 * Find the intersection along the z-axis where the line segment between p0 and p1 would intersect with the isosurface.
	 */
	void intersectZAxis(Point& p0, Point& p1, Point& out, glmd::int32 gridX, glmd::int32 gridY, glmd::int32 gridZ, const Points& densityValues) const;
	
	/**
	 * Generate the vertex for the given block at position x, y, z.
	 */
	void generateVertex(Blocks& blocks, glmd::int32 x, glmd::int32 y, glmd::int32 z, glmd::int32 gridX, glmd::int32 gridY, glmd::int32 gridZ, const Points& densityValues) const;
	 ...
	 */
	void computeCubes(Blocks& blocks, glmd::int32 y, glmd::int32 gridX, glmd::int32 gridY, glmd::int32 gridZ, const Points& densityValues) const;

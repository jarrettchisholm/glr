...
public:
	...
	virtual terrain::ITerrainManager* getTerrainManager(terrain::IFieldFunction* fieldFunction = nullptr, terrain::TerrainSettings terrainSettings = terrain::TerrainSettings());
